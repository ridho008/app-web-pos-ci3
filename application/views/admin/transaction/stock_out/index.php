  ...
  <section class="content">
    <div class="row">
      <div class="col-md">
        <div class="row">
          <div class="col-md-6">
            <button type="button" class="btn btn-outline-primary mb-2 tombolTambahStockIn" data-toggle="modal" data-target="#formmodalStockOut">Tambah Stock Barang Keluar</button>
            <?= $this->session->flashdata('pesan'); ?>
          </div>
        </div>
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Barang Keluar / Pembelian</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
                ...
                <?php $no = 1; foreach($t_stock_in as $tsi) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="<?= base_url('stock/out/del/') . $tsi['id_stock'] . '/' . $tsi['id_pitem']; ?>" onclick="return confirm('Yakin ?')" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
...
<div class="modal fade" id="formmodalStockOut">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('stock/out/process'); ?>" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Rusak / Hilang / etc" name="detail" id="detail">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <button type="submit" class="btn btn-primary">Tambah Stock Out</button>
          </div>
        </form>
      </div>
    </div>
